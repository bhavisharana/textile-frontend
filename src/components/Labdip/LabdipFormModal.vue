...
<template>
  <BasicDialog :is-open="isOpen" :title="isEditing ? 'Edit Labdip' : 'Create New Labdip'" max-width="680px" :loading="labdipStore.loading" :submit-text="isEditing ? 'Update' : 'Save'" @close="closeModal" @submit="onSubmit">
    <form id="labdip-form" @submit.prevent="onSubmit" class="modal-form-content">
